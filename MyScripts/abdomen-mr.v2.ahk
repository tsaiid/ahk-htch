...
2.  Lesions:
      ...
      R:             :-cen/junctional(  ) or peripheral (  ).  Sign of diffusional restriction (    ). Enhancement (  )
...
Lymphadenopathy: pelvic (  ) or para-aortic ( ).
- site: Obturator (  R/L), Internal iliac (  R/L), External iliac (  R/L), Sacral (  R/L), para-aortic (yes/no).

6. Other sites of metastasis ( ). (Regional/non-regional. Location: )

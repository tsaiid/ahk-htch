...
(function() {
    ...
    function isMsk(examName) {
        return examName.match(/JOINT|Leg|Hand-CT|Forearm- CT|Femur|foot (CT|MRI)/);
    }
    ...
    const simExam = {
        ...
        'Liver (Primovist) MRI': ['ABDOMEN Liver MRI', 'Abdomen  Liver 4 Phase CT', 'Abdomen  Liver Triple Phase CT'],

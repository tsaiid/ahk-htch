...
AHKHID_GetDevHandle(i)
	{
		Return NumGet(AHKHID_Initialize(), (i - 1) * (A_PtrSize * 2), "UPtr")
	}
...
AHKHID_GetDevType(i, IsHandle := False)
	{
		Return Not IsHandle ? NumGet(AHKHID_Initialize(), ((i - 1) * (A_PtrSize * 2)) + A_PtrSize, "UInt") : NumGet(AHKHID_Initialize(), ((AHKHID_GetDevIndex(i) - 1) * (A_PtrSize * 2)) + A_PtrSize, "UInt")
	}
